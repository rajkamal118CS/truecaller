          ...
          <div class="col-12 mx-auto">
                ...
                <div class="mt-2">
                    <div class="text-center p-3">
                        <h3 class="theme-color">All Available contact</h3>
                    </div>
                </div>
                ...
                <?php
                  ...
                  $sql= "CALL contact_by_profession('$profession')";
                  ...
                  if(mysqli_num_rows($ret)==0)
                  {
                      echo "<div id='card'><h1>No contact present for given profession</h1><form action='dashboard.php'><button type='submit' id='done'>Done</button></form></div>";
